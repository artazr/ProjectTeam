...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 8888, 'dbname' => 'ProjecTeam', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $d, $f, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Acme/CoreBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Acme/UserBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Acme\\CoreBundle\\Entity');
        $c->addDriver($b, 'Acme\\UserBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('AcmeCoreBundle' => 'Acme\\CoreBundle\\Entity', 'AcmeUserBundle' => 'Acme\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7646c27fdba6a90622ad7154f20726db65179064123489f103c3f326a6c46a6f');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Acme/CoreBundle/Resources/views'), 'AcmeCore');
        $instance->addPath(($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/views'), 'VichUploader');
        $instance->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'/src/Acme/UserBundle/Resources/views'), 'AcmeUser');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('1482ffe408e8335ea604bb84936ce104d2338c13');
    }
    ...
    {
        return $this->services['vich_uploader.property_mapping_factory'] = new \Vich\UploaderBundle\Mapping\PropertyMappingFactory($this, $this->get('vich_uploader.metadata_reader'), array('product_image' => array('uri_prefix' => '/logo', 'upload_destination' => ($this->targetDirs[2].'/../web/logo'), 'inject_on_load' => false, 'delete_on_update' => true, 'delete_on_remove' => true, 'namer' => NULL, 'directory_namer' => NULL, 'db_driver' => 'orm')), '_name');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AcmeCoreBundle' => 'Acme\\CoreBundle\\AcmeCoreBundle',
            ...
            'locale' => 'fr',
            'secret' => '1482ffe408e8335ea604bb84936ce104d2338c13',
            ...
            'kernel.secret' => '1482ffe408e8335ea604bb84936ce104d2338c13',
            ...
            'assetic.java.bin' => '/usr/sbin/java',
            ...
            'vich_uploader.mappings' => array(
                'product_image' => array(
                    'uri_prefix' => '/logo',
                    'upload_destination' => ($this->targetDirs[2].'/../web/logo'),
